...
public class TowerRabbit : MonoBehaviour
{
    ...
    IEnumerator Shoot()
    {
        ...
        lighting.transform.localScale = new Vector3(lighting.transform.localScale.x * 0.8f, lighting.transform.localScale.y  * 0.8f,
            lighting.transform.localScale.y * Vector3.Distance(startBullet.position, targets[0].transform.position) / 2f);
